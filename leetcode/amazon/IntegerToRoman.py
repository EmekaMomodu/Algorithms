...
class Solution:
    def intToRoman(self, num: int) -> str:
        ...
        for baseValue in baseValues:
            wholeQuotient = currentNum // baseValue[0]
            print("baseValue: " + str(baseValue) + ", " + "wholeQuotient: " + str(wholeQuotient))
            if wholeQuotient >= 1:
                romanValue = baseValue[1]
                romanNumeral += romanValue * wholeQuotient
                currentNum = currentNum % baseValue[0]
